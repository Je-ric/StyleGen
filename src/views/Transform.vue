<template>
  <GeneratorLayout title="Transform Generator" subtitle="Scale, rotate, translate, and skew elements visually"
    :css="css" :tailwind="'/* Tailwind arbitrary values */\n' + css">
    <template #presets>
      <button @click="reset" class="sg-preset-btn">Default</button>
    ...
    <div class="hidden md:grid grid-cols-[220px_1fr_220px] gap-5 items-start">
      ...
      <div class="sg-card p-5 flex flex-col gap-4">
        ...
        <div class="flex-1 flex justify-center items-center min-h-72 bg-slate-50 rounded-xl border overflow-hidden" style="border-color:var(--border)">
    ...
    <div class="md:hidden flex flex-col gap-4">
      <div class="sg-card p-4 flex flex-col gap-3">
        <div class="flex justify-center items-center min-h-48 bg-slate-50 rounded-xl overflow-hidden">
